...
filesystem/shell behavior outside the reusable `loom_agent` package.
"""
...
from loom_agent.messages import ImageContent, TextContent
...
from loom_coding.image_processing import (
