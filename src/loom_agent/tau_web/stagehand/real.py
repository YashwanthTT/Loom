...
already-working loom_ai provider (OpenCode Go subscription).
...
def make_llm_callback(config, on_call=None):
    ...
    from loom_agent.messages import ImageContent, TextContent, UserMessage
    from loom_agent.provider_events import AssistantDoneEvent, AssistantErrorEvent
